class AccessToken {
  ...
  ///A space-separated list of scopes which have been granted for this [token].
  String scope;
  ...
  AccessToken(this.token, this.scope, this.expiresIn, this.refreshToken) {
    tokenType = 'Bearer';
  ...
  factory AccessToken.fromJSON(Map<String, dynamic> json) {
    return AccessToken(json['access_token'], json['scope'], 
