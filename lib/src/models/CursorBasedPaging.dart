...
class CursorBasePaging {
  ...
  CursorBasePaging(this.href, this.items, this.itemType, this.limit, this.next,
                  this.cursor, this.offset, this.previous, this.total);    

  factory CursorBasePaging.fromJSON(SpotifyType type, Map<String, dynamic> json) {
    ...
    return CursorBasePaging(json['href'], items, type, json['limit'], 
